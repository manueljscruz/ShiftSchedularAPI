...
{
    public class RangeWithResourceMessageAttribute : RangeAttribute
    {
        public RangeWithResourceMessageAttribute(double minimum, double maximum, Type resourceType, string resourceKey) : base(minimum, maximum)
        {
