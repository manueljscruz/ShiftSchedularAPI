...
namespace ShiftSchedularAPI.Controllers
{
    ...
    public class AdminPaymentMethodTypesController : ControllerBase
    {
        ...
        public AdminPaymentMethodTypesController(IPaymentMethodTypeService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Upsert([FromBody] AdminUpsertPaymentMethodTypeDTO dto)
        {
