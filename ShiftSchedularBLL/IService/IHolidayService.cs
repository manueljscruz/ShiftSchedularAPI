...
namespace ShiftSchedularBLL.IService
{
    public interface IHolidayService
    {
        ...
        Task<BaseResponse<bool>> DeleteEntityHoliday(EntityHolidayDTO entityHolidayDTO);
        ...
        Task<EntityHolidaysViewModel> GetEntityHolidaysViewModel(BaseViewModelRequest viewModelRequestDTO);
