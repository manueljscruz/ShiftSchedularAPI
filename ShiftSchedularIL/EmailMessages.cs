namespace ShiftSchedularIL
{
    public class EmailMessages
    {
        ...
        public const string INVITATION_EMAIL = @"
        <!DOCTYPE html>
            <html lang=""en"">
            <head>
                <meta charset=""UTF-8"">
                <meta name=""viewport"" content=""width=device-width, initial-scale=1.0"">
                <title>You Have a New Invitation - Shift Scheduler</title>
            </head>
            <body style=""margin: 0; padding: 0; font-family: 'Roboto', 'Helvetica Neue', Arial, sans-serif; background-color: #f8f9fa;"">
                <table width=""100%"" cellpadding=""0"" cellspacing=""0"" style=""background-color: #f8f9fa; padding: 40px 20px;"">
                    <tr>
                            ...
                            <table width=""600"" cellpadding=""0"" cellspacing=""0"" style=""background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1); overflow: hidden; max-width: 100%;"">
                                ...
                                <tr>
                                    <td style=""background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); padding: 40px 30px; text-align: center;"">
                                        ...
                                        <h1 style=""margin: 0; color: #ffffff; font-size: 28px; font-weight: 600;"">You Have a New Invitation</h1>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style=""padding: 40px 30px;"">
                                        ...
                                        <p style=""margin: 0 0 20px; color: #555555; font-size: 16px; line-height: 1.6;"">
                                            You have been invited to join an organisation on Shift Scheduler. Visit your invitations page to review and respond to the invitation.
                                        </p>
                                        ...
                                        <table width=""100%"" cellpadding=""0"" cellspacing=""0"" style=""margin: 30px 0;"">
                                            <tr>
                                                <td align=""center"">
                                                    <a href=""[InvitationsLink]"" style=""display: inline-block; background-color: #C03221; color: #ffffff; text-decoration: none; font-weight: 600; font-size: 16px; padding: 14px 40px; border-radius: 10px; box-shadow: 0 4px 12px rgba(192, 50, 33, 0.3); letter-spacing: 0.5px; text-transform: uppercase;"">
                                                        View My Invitations
                                                    </a>
                                                </td>
                                            </tr>
                                        ...
                                        <p style=""margin: 0 0 20px; word-break: break-all;"">
                                            <a href=""[InvitationsLink]"" style=""color: #C03221; text-decoration: none; font-size: 14px;"">[InvitationsLink]</a>
                                        </p>
